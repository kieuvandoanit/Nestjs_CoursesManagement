...
export class BaseRepository<T> {
  ...
  // constructor(
  //   @InjectModel('User') private readonly _model: Model<T>
  // ){}
  ...
  //   const item = await this._model.findByIdAndUpdate(id, data).exec();

  //   return item?.toObject<T>() ?? null;
  // }

  // public async update(filter: Partial<T>, data: T): Promise<T> {
  ...
  // public async aggregate(pipelines: Array<object>): Promise<Array<any>>{
